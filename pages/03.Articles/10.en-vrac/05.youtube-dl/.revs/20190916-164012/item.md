...
```bash
$ youtube-dl https://www.youtube.com/watch?v=7Uexuyy_HL8
...
Options:
  ...
  Network Options:
    --proxy URL                      Use the specified HTTP/HTTPS/SOCKS proxy. To enable SOCKS proxy, specify a proper scheme. For example socks5://127.0.0.1:1080/. Pass in an empty string (--proxy
