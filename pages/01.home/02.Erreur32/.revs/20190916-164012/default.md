...
<h2>  Art of Life </h2>
 <span class="label label-primary">  Luttez pour vos droits et votre liberté sur internet !</span>
    <h3>  Évitez les   <strong>GAFAM</strong>  irrespectueux de vos données ! </h3>
 <blockquote>
  ...
  par leur collecte, leur traitement, leur stockage et leur commerce.    <br>    
  &nbsp;&nbsp;&nbsp;  Ces pratiques, dangereuses pour nos libertés en ligne et hors ligne, sont particulièrement répandues sur Internet. <br>  
  &nbsp;&nbsp;  - laquadrature.net , explication sur la neutralité du net !!   &nbsp;&nbsp;&nbsp;<a href="https://www.laquadrature.net/fr/neutralite_du_Net"> neutralite du Net</a>
</blockquote>
  <br>  
    Rejoignez la procédure contre les <strong> GAFAM </strong>
   <br> 
                                                  <code>                Google , Apple , Facebook , Amazon , Microsoft  </code>
    <br>
